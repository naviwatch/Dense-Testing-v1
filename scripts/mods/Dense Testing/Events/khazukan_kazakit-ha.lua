...
-- https://github.com/Aussiemon/Vermintide-2-Source-Code/blob/e2524e01cb1b545febfa4cb04753e22d44f897d8/scripts/settings/terror_events/terror_events_dlc_dwarf_beacon.lua

TerrorEventBlueprints.dwarf_beacondwarf_beacons_gate_part1 = {
	{
...
TerrorEventBlueprints.dwarf_beacons_gate_part3 = {
	{
		"set_master_event_running",
		name = "beacons_gate",
	},
...
TerrorEventBlueprints.dwarf_beacons_skaven_horde = {
	{
		"set_master_event_running",
...
TerrorEventBlueprints.dwarf_beacons_barrier = {
	{
		"set_master_event_running",
...
TerrorEventBlueprints.dwarf_beacons_horde_fleeing = {
	{
		"set_master_event_running",
