...
--	local difficulty_name = deathwish_enabled and "deathwish_onslaught" or base_difficulty_name .. "_Dense Testing"
--
--	if difficulty_name ~= self.current_difficulty_name then
--		self:_set_difficulty_name(deathwish_enabled and "Deathwish Dense Testing" or Localize(base_difficulty_name) .. " Dense Testing")
--
